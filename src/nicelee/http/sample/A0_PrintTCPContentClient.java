...
//			socket.connect(new InetSocketAddress("127.0.0.1", 666));
//			socket.connect(new InetSocketAddress("m.baidu.com", 80));
			socket.connect(new InetSocketAddress("nicelee.top", 8090));
			
			BufferedReader reader = new BufferedReader(new InputStreamReader(socket.getInputStream()));
			BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream()));
			System.out.println("发送请求... ");
			writer.write("GET /ftp/hello/ HTTP/1.1\r\n");
			writer.write("Host: nicelee.top:8090\r\n");
			writer.write("Connection: keep-alive\r\n");
			//writer.write("Authorization: Basic bGlqaWE6bGlqaWE4NDU\r\n");
